...
parser = argparse.ArgumentParser(description='Manual Matplotlib Reporting Example')
parser.add_argument('--project-name', type=str, default="visualization-poc", help='ClearML project name')
parser.add_argument('--task-name', type=str, default="manual_matplotlib reporting", help='ClearML task name')
